...
const int out_of_value_threshold = 2000;              // valor para medir cambios no naturales de disparo
...
bool trigger_validation() {
  if ((millis() - fst_detection > time_of_detection) && evaluation) {  //evalua el tiempo de analisis
    ...
    if ((peaks >= 1 && peaks <= 3) && !spasm_dt) {  //evaluar los picos necesarios para enter
